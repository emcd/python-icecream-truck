...
def main( ):
    ...
    try: env = next( e for e in Environment if e.value == env_name )
    ...
    flavors = {
        ...
        # Severity levels - can use as alternatives to trace levels
    ...
    # Install the truck with appropriate settings
    ...
    # Run the application with configured debugging
    run_application( )

def run_application( ):
    ''' Simulates application with various debug outputs. '''
    # Top-level trace (visible in all environments)
